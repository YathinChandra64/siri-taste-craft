...
const UPIScreenshotUpload = ({
  ...
  const [processingStatus, setProcessingStatus] = useState<
    "idle" | "uploading" | "ocr_processing" | "validating" | "complete" | "error"
  >("idle");
  ...
  return (
    <div className="space-y-4">
      ...
      {!ocrResult && (
        ...
        >
          ...
          >
            ...
            <h3 className="text-white font-semibold mb-1">Upload Payment Receipt</h3>
            ...
            <Card className="bg-slate-800 border-slate-700 p-4">
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  {[
                    { stage: "uploading", label: "Uploading screenshot..." },
                    { stage: "ocr_processing", label: "Extracting text with OCR..." },
                    { stage: "validating", label: "Validating UTR..." },
                    { stage: "complete", label: "Processing complete!" }
                  ].map(({ stage, label }) => (
                    <div key={stage} className="flex items-center gap-3">
                      {processingStatus === stage ? (
                        ...
                        ["uploading", "ocr_processing", "validating"].includes(stage) ? (
              ...
              <div className="flex gap-3">
                ...
                <div className="flex-1">
                  <h4 className={`font-semibold mb-1 ${
                    ...
                    {ocrResult.utrDetected ? "✅ UTR Extracted" : "⚠️ UTR Not Detected"}
                  </h4>
                  {ocrResult.utrDetected && (
                  ...
                  {!ocrResult.utrDetected && (
                    <p className={`text-yellow-200 text-sm`}>
                      We couldn't automatically detect the UTR. Our team will verify it manually.
                    </p>
                  )}
                </div>
              </div>
      ...
      <p className="text-xs text-slate-400 text-center">
        💡 Our system automatically extracts the UTR using OCR. If it's not detected, we'll verify it manually.
      </p>
    </div>
  );
};
